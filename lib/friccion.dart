...
class _FriccionActivityState extends State<FriccionActivity> {
  ...
  Future<void> _pickImage() async {
    try {
      ...
      setState(() => _equipoImageBytes = bytes);
          ...
          build: (context) {
            return pw.Column(
              ...
              children: [
                ...
                pw.SizedBox(height: 10),
                // Gráfico con tamaño reducido: Altura 100
                pw.Center(
                  child: pw.SizedBox(
                    height: 100, // MODIFICADO: Altura ajustada para el PDF
                ...
                pw.Text(
                  "Los resultados presentados corresponden a estimaciones basadas en promedio de sistemas similares y el impacto de las restricciones en el sistema de bombeo. Se recomienda realizar un estudio detallado para determinar con exactitud los ahorros reales. La inversión considerada en este análisis corresponde únicamente al cambio del sistema de bombeo.",
                  style: pw.TextStyle(fontSize: 10),
  ...
  Widget _buildTcoChart() {
    ...
    return RepaintBoundary(
      key: _chartKey,
      child: SizedBox(
        height: 195, // Altura mantenida para la captura de imagen de Flutter
        child: LineChart(
          LineChartData(
            minX: 0,
            maxX: 5,
