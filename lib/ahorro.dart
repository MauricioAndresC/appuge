...
class _AhorroScreenState extends State<AhorroScreen> {
  ...
  Future<void> _generatePdf() async {
    ...
    try {
      ...
      final ui.Image chartImage = await boundary.toImage(pixelRatio: 2.5);
          ...
          build: (context) => [
            pw.Row(
              ...
              children: [
                ...
                pw.Image(pw.MemoryImage(logoBytes), width: 120, height: 40),
              ],
            ),
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              if (_tcoTable.isNotEmpty) _buildTcoChart(),
            ],
          ),
        ),
      ),
