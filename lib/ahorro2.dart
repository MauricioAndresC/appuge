...
class _Ahorro2ScreenState extends State<Ahorro2Screen> {
  ...
  List<Map<String, double>> _tcoTable = []; // Tabla de precios

  // Tabla de precios (HP -> costo COP por rango)
  final Map<String, double> preciosBombas = {
    "0-5 Hp": 6500000 * 1.7,
    "5-10 Hp": 8800000 * 1.7,
    "10-15 Hp": 10600000 * 1.7,
    "15-20 Hp": 12500000 * 1.7,
    "20-30 Hp": 15320000 * 1.7,
    "30-40 Hp": 22750000 * 1.7,
    "40-50 Hp": 28000000 * 1.7,
    "50-75 Hp": 35000000 * 1.7,
  };

  final _fmt = NumberFormat('#,##0', 'es_CO'); // Formato de números
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Imagen cargada correctamente ok')),
        );
      }
    } catch (e) {
  ...
  Future<void> _generatePdf() async {
    // Retraso para asegurar que el gráfico se renderice completamente antes de capturar la imagen.
    ...
    try {
      ...
      pdf.addPage(
        pw.Page(
          ...
          build: (context) {
            // ALTURA DE IMAGEN REDUCIDA DE 100 A 70, TAMAÑOS DE FUENTE AJUSTADOS
            return pw.Column(
              ...
              children: [
                ...
                pw.SizedBox(height: 8), // Reducido de 10 a 8
                        ...
                        children: [
                          ...
                          if (_equipoImageBytes != null)
                            pw.Image(
                              ...
                              height: 70, // Reducido de 100 a 70
                ...
                pw.Divider(),
                pw.SizedBox(height: 10), // Reducido de 12 a 10
                ...
                pw.SizedBox(height: 12), // Reducido de 16 a 12
                ...
                pw.SizedBox(height: 10), // Reducido de 18 a 10
                ...
                // Altura del gráfico reducida de 200 a 180
                pw.Center(
                  child: pw.Image(pw.MemoryImage(chartBytes), height: 180),
                ),
  ...
  // Se reducen los paddings y tamaños de fuente para ahorrar espacio vertical.
  pw.Widget _infoBox(
    String title,
    String value,
    PdfColor bg,
    ...
    return pw.Expanded(
      child: pw.Container(
        padding: const pw.EdgeInsets.all(8), // Reducido de 12 a 8
        decoration: pw.BoxDecoration(
          color: bg,
          borderRadius: pw.BorderRadius.circular(8),
        ),
  ...
  // ... resto de la clase _Ahorro2ScreenState sin cambios para la UI de Flutter ...
